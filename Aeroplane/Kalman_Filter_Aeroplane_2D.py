...
## Plotting graphs ##
plt.plot(measurement_position,measurement_velocity)
plt.plot(prediction['position'],prediction['velocity'])
plt.plot(kalman_filter['position'],kalman_filter['velocity'])
plt.grid(which='both')
